...
public class ConsultaLike {
     public static void main(String[] args) {
        ...
        try{
            ...
            ResultSet rs = statement.executeQuery("SELECT * FROM excusa_entrega WHERE (excusa LIKE'%perro%' OR excusa LIKE '%gato%') AND (dias_retraso BETWEEN 2 AND 6) ORDER BY dias_retraso desc");
